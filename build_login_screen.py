...
frontend_dir = r"d:\Odoo\assetflow\frontend"
...
# Overwriting LoginPage.jsx to match the exact visual layout and components in the screenshot
create_file("src/pages/LoginPage.jsx", """
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 bg-slate-950/40 border border-slate-800 rounded-2xl py-3 text-white placeholder-slate-500 focus:border-indigo-500 outline-none"
                    value={form.email}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-11 bg-slate-950/40 border border-slate-800 rounded-2xl py-3 text-white placeholder-slate-500 focus:border-indigo-500 outline-none"
                    value={form.password}
...
print("LoginPage matching screenshot generated successfully.")
